...
hidden if the `sparse_merkle_tree_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sparse_merkle_tree_DEVELOPER_MODE` to the configure
